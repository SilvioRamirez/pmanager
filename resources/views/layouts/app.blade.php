            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('companies.index') }}">Mis Compañias</a>
                            </li>
                            <li class="nav-item">
                            ...
                            @if(Auth::user()->role_id == 1 )
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarAdmin">
                                        <a class="dropdown-item" href="{{ route('projects.index') }}" >Proyectos</a>
                                        <a class="dropdown-item" href="{{ route('users.index') }}" >Usuarios</a>
                                        <a class="dropdown-item" href="{{ route('tasks.index') }}" >Tareas</a>
                                        <a class="dropdown-item" href="{{ route('companies.index') }}" >Compañias</a>
